...
```
cd existing_repo
git remote add origin https://gitlab.dotnetfalcon.com/evosoft/msbuild/2023-evo02/kurzuskod.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.dotnetfalcon.com/evosoft/msbuild/2023-evo02/kurzuskod/-/settings/integrations)
